...
#line 55 "/tmp/CompilersCourse/parser.cpp"
...
namespace yy {
#line 146 "/tmp/CompilersCourse/parser.cpp"
...
#line 889 "/tmp/CompilersCourse/parser.cpp"
    break;
...
#line 895 "/tmp/CompilersCourse/parser.cpp"
    break;
...
#line 901 "/tmp/CompilersCourse/parser.cpp"
    break;
...
#line 931 "/tmp/CompilersCourse/parser.cpp"
    break;
...
#line 937 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 11:
#line 139 "parser.y"
                   { yylhs.value.as < std::shared_ptr<Statement> > () = std::make_shared<LocalVarDeclStmt>(yystack_[0].value.as < std::shared_ptr<Var> > ()); }
#line 943 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 12:
#line 140 "parser.y"
                                 { yylhs.value.as < std::shared_ptr<Statement> > () = std::make_shared<StmtListStmt>(yystack_[1].value.as < std::shared_ptr<StatementsList> > ()); }
#line 949 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 13:
#line 141 "parser.y"
                                     { yylhs.value.as < std::shared_ptr<Statement> > () = std::make_shared<If>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), yystack_[0].value.as < std::shared_ptr<Statement> > ()); }
#line 955 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 14:
#line 142 "parser.y"
                                                    { yylhs.value.as < std::shared_ptr<Statement> > () = std::make_shared<IfElse>(yystack_[4].value.as < std::shared_ptr<ExpressionBase> > (), yystack_[2].value.as < std::shared_ptr<Statement> > (), yystack_[0].value.as < std::shared_ptr<Statement> > ()); }
#line 961 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 15:
#line 143 "parser.y"
                                        { yylhs.value.as < std::shared_ptr<Statement> > () = std::make_shared<While>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), yystack_[0].value.as < std::shared_ptr<Statement> > ()); }
#line 967 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 16:
#line 144 "parser.y"
                                           { yylhs.value.as < std::shared_ptr<Statement> > () = std::make_shared<PrintStmt>(yystack_[1].value.as < std::shared_ptr<ExpressionBase> > ()); }
#line 973 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 41:
#line 197 "parser.y"
                    {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::AND     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 979 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 42:
#line 198 "parser.y"
                    {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::OR     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 985 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 43:
#line 199 "parser.y"
                        {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::GREATER     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 991 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 44:
#line 200 "parser.y"
                      {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::EQUAL     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 997 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 45:
#line 201 "parser.y"
                     {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::PLUS     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 1003 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 46:
#line 202 "parser.y"
                      {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::MINUS     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 1009 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 47:
#line 203 "parser.y"
                     {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::STAR     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 1015 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 48:
#line 204 "parser.y"
                      {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::SLASH     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 1021 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 49:
#line 205 "parser.y"
                    {yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<BinaryOp>(yystack_[2].value.as < std::shared_ptr<ExpressionBase> > (), BinaryOp::Operation::MOD     , yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ());}
#line 1027 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 50:
#line 206 "parser.y"
                        { yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<True>(); }
#line 1033 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 51:
#line 207 "parser.y"
                         { yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<True>(); }
#line 1039 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 53:
#line 209 "parser.y"
         { yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<Id>(yystack_[0].value.as < std::string > ()); }
#line 1045 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 54:
#line 210 "parser.y"
              { yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<Int>(yystack_[0].value.as < int > ()); }
#line 1051 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 56:
#line 212 "parser.y"
           { yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<True>(); }
#line 1057 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 57:
#line 213 "parser.y"
            { yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<False>(); }
#line 1063 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 59:
#line 215 "parser.y"
               { yylhs.value.as < std::shared_ptr<ExpressionBase> > () = std::make_shared<Not>(yystack_[0].value.as < std::shared_ptr<ExpressionBase> > ()); }
#line 1069 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 60:
#line 218 "parser.y"
                  { yylhs.value.as < int > () = yystack_[0].value.as < int > (); }
#line 1075 "/tmp/CompilersCourse/parser.cpp"
    break;

  case 61:
#line 219 "parser.y"
                      { yylhs.value.as < int > () = -yystack_[0].value.as < int > (); }
#line 1081 "/tmp/CompilersCourse/parser.cpp"
    break;


#line 1085 "/tmp/CompilersCourse/parser.cpp"
...
#line 1611 "/tmp/CompilersCourse/parser.cpp"
